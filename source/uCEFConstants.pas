...
const
  ...
  IDC_TOGGLE_VERTICAL_TABS_COLLAPSE = 34061;
  IDC_COPY_URL = 34071;
  IDC_OPEN_IN_CHROME = 34072;
  IDC_WEB_APP_SETTINGS = 34073;
  IDC_WEB_APP_MENU_APP_INFO = 34074;
  IDC_WEB_APP_UPGRADE_DIALOG = 34075;
  ...
  IDC_CHROME_ENTERPRISE_RELEASE_NOTES = 40305;
  ...
  IDC_SPELLCHECK_REMOVE_FROM_DICTIONARY = 41112;
  ...
  IDC_CONTENT_CONTEXT_SAVE_TO_MEMORY_BANKS = 50183;
  ...
  IDC_OMNIBOX_CONTEXT_SMART_TAB_SHARING = 54020;
  ...
  /// </summary>
  /// <remarks>
  /// <para>TCefMediaRouteConnectionState values.</para>
